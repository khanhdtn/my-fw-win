...
namespace ProtocolVN.Framework.Win
{
    ...
    public partial class PLWord : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void iReplace_ItemClick(object sender , DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ProtocolForm.ShowDialog((XtraForm)this.FindForm(), dlgReplace);
        }
        ...
        {
            HelpRichTextBox.SetData(byteContent, this.rtbData);
        ...
        {
            HelpMsgBox.ShowNotificationMessage("Đang xây dựng");
        }

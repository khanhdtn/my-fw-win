...
namespace ProtocolVN.Framework.Win
{
    ...
    public class RepositoryItemDataTreeNew : RepositoryItemPopupContainerEdit
    {
        ...
        static RepositoryItemDataTreeNew()
        {
            Register();
        }
        private void init()
        ...
        public RepositoryItemDataTreeNew(XtraForm danhMucForm , GridView gridView ,string columnField, string TableName , int[] RootID , string ValueField , string IDParentField , string[] VisibleFields , string[] Captions , string getField)
        {
            init();
        ...
        public static void Register()
        {
            EditorRegistrationInfo.Default.Editors.Add(new EditorClassInfo(ControlName ,
                                        typeof(TrialPLDataTreeNew) , typeof(RepositoryItemDataTreeNew) ,

...
namespace ProtocolVN.Framework.Win
{
    ...
    public partial class TrialPLDanhMucAdvCtrl : DevExpress.XtraEditors.XtraUserControl,IDanhMucAdv
    {
        ...
        {
            TrialPLDanhMucAdv.isClosePopup = false;

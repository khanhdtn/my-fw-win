...
{
    public partial class UserControlDataTreeExt : DevExpress.XtraEditors.XtraUserControl
    {
        private int[] RootID;
        ...
        public void _BuildTree(XtraForm danhMucForm,string btnCaption, GetValue function, string TableName, int[] RootID, string IDField, string IDParentField, string[] VisibleFields, string[] Captions, string getField)
        {
            this._initTree(IDField, IDParentField, VisibleFields, Captions);
            this.danhMucForm = danhMucForm;
            this.IDField = IDField;
        ...
        {
            TrialPLDataTreeNewExt.isClosePopup = false;
        ...
        {
            DataRowView drView = (DataRowView)treeList1.GetDataRecordByNode(treeList1.FocusedNode);
            DataRow dr = drView.Row;
            formValue(HelpNumber.ParseInt32(dr[IDField]));
        }

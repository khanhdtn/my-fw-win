...
{
    sealed class FWMenu22x : IFWMenu
    {
        ...
        public string CreateHelpMenu()
        {
            ...
            //MenuBuilder.CreateItem(str, SPECIAL_MENU_ITEM.UPDATEPROGRAM.ToString(), "Cập nhật chương trình", PLHELP, true, "", true, false, "0", false, "", "Chương trình sẽ được tải về từ máy chủ và cập nhật vào máy.", true);
            ...
            MenuBuilder.CreateItem(str, "PLHELP.3", "Về tác giả", PLHELP, true, typeof(frmPLAbout).FullName, false, true, "1", false, "", "", true);
